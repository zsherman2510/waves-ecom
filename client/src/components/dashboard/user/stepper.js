...
import { userUpdateEmail } from "store/actions/usersActions";
...
const EmailStepper = ({ users }) => {
  ...
  const steps = ["Enter your old email", "Enter your new email", "Are you Sure?"]
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(userUpdateEmail(values));
      setLoading(true);
